                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" action="{{ route('course.store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name_course" class="form-control" id="name_course" placeholder="ادخل اسم الكورس" required>
                        </div>
                        <div class="form-group">
                            <label for="description_course">Course description </label>
                            <textarea name="description_course" class="form-control" id="description_course" rows="3" placeholder="اكتب وصف بسيط"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="image_course"> Image link</label>
                            <input type="text" name="image_course" class="form-control" id="image_course" placeholder="رابط الصورة (URL)">
                        </div>
                        <div class="form-group">
                            <label for="video_course">Video link</label>
                            <input type="text" name="video_course" class="form-control" id="video_course" placeholder="رابط الفيديو (URL)">
                        </div>
                        <div class="form-group">
                            <label for="price_course">course price ($)</label>
                            <input type="number" name="price_course" step="0.01" class="form-control" id="price_course" placeholder="ادخل السعر">
                        </div>
